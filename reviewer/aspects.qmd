...
Did the author make an attempt to pick names that are consistent with the rest of the codebase?
...
Consistent naming makes code significantly easier to understand, because it lowers your cognitive burden if you know that, say, `loc` always stands for an integer value corresponding to a vector index.
...
Taking a moment to have the author clarify confusing sections of code will help future developers when it is modified further.
