...
If you never submit an improvement to a package, then the package never improves.
...
Linking out to sections of the style guide, design guide, or this code review guide are ways to point to a concrete source of truth that the PR author can read to align their contributions with tidyteam standards.
