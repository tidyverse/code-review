...
If the PR is too large for you to figure out which parts are the major parts, ask the author to provide a [recommended reading order](#sec-reading-order), or ask them to [split up the PR into multiple PRs](#sec-small).
